          ...
          <View className="absolute bg-white rounded-t-[20px] h-[554px] left-0 right-0 bottom-0 ">
            <View className="flex justify-center  items-center mx-7">
              ...
              <Pressable onPress={() => router.push('/Content/Contact')} className="mt-24 bg-[#FF9134] rounded-[10px] flex justify-center items-center  w-full  h-[58px]">
                <Text className="text-white text-[18px] font-[500]">Login</Text>
              </Pressable>
              <Pressable onPress={()=> router.push('/Auth/signUp')} className="flex flex-row gap-1  mt-10">
                <Text className="text-black text-[13px] font-[500]">Don’t have an account? </Text>
                <Text className="text-[#FF9134] text-[13px] font-[500]"> Sign up here</Text>
              </Pressable>
            </View>
          </View>
        </View>
